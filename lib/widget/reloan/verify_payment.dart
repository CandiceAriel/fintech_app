...
class VerifyPaymentView extends StatefulWidget {
  ...
  @override
  State<VerifyPaymentView> createState() => _VerifyPaymentViewState();
}

class _VerifyPaymentViewState extends State<VerifyPaymentView> {
                          ...
                          Expanded(
                            ...
                            child:  Padding(
                              ...
                              child: Column(
                                ...
                                // )
                                _PayButton(selectedVal: selectedMethod, onPressed: widget.onPressed)
                              ],
                          ),
                        )
